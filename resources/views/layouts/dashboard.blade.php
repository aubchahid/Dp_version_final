...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed {{ __('lang.dir') }}">
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li>
                                <a href="/users"><i class="iconly-User3">
                                        <span class="path1"></span><span
                                            class="path2"></span></i><span>{{ __('lang.Users') }}</span></a>
                            </li>
                            <li>
                                <a href="/users"><i class="iconly-Graph">
                                        <span class="path1"></span><span
    ...
    <script>
        window.livewire.on('success', () => {
            ...
            $('#activeSchool').modal('hide');
            $('#desactiveSchool').modal('hide');
            $('#editCandidat').modal('hide');
            $('#addMoniteur').modal('hide');
            $('#deleteMoniteur').modal('hide');
            $('#addCar').modal('hide');
        });
