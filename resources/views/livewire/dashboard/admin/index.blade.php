<section class="content">
    <div class="row">
        <div class="col-lg-12 col-12">
            <div class="box">
                <div class="box-body bg-img" style="background-image: url({{ asset('assets/images/bg-5.png') }});"
                    data-overlay-light="9">
                    <div class="d-lg-flex align-items-center justify-content-between">
                        <div class="d-md-flex align-items-center mb-30 mb-lg-0 w-p100">
                            <img src="{{ asset('assets/images/svg-icon/color-svg/custom-14.svg') }}"
                                class="img-fluid max-w-150" alt="">
                            <div class="ml-30">
                                <h3 class="mb-10">{{ __('lang.WelcomeToDashboard') }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="box">
                <div class="box-body d-flex align-items-center">
                    <i class="iconly-User3 h1 ml-2"></i>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="box">
                <div class="box-body d-flex align-items-center">
                    <i class="iconly-Graph h1 ml-2"></i>
