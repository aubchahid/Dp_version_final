                         ...
                         <div class="col-12">
                             <div>
                                 <p>{{ __('lang.Email') }} <br> <span
                                         class="text-gray">{{ $school->admin->email }}</span> </p>
                                 <p>{{ __('lang.PhoneNo') }} <br> <span
                                         class="text-gray">{{ $school->phoneNumber($school->phoneNo) }}</span>
                                 </p>
                                 <p>{{ __('lang.Address') }} <br> <span
                                         class="text-gray">{{ $school->address . ', ' . $school->city }}</span>
                                 </p>
                                 <p>{{ __('lang.Founded') }} <br> <span
                                         class="text-gray">{{ $school->founded }}</span></p>
                                 <p>{{ __('lang.WorkingTime') }} <br> <span
                                         class="text-gray">{{ $school->wrokingTime }}</span></p>
                                 <p>{{ __('lang.Experience') }} <br> <span
                                         class="text-gray">{{ $school->experience . ' ' . __('lang.Years') }}</span>
                                 </p>
             ...
             <div class="box">
                 <div class="box-body">
                     <div class="flexbox align-items-baseline mb-20">
                         <h6 class="text-uppercase ls-2">{{ __('lang.NumberOfCandidat') }}</h6>
                         <small>20</small>
                     </div>
                 ...
                 <div class="box-footer">
                     <a class="text-uppercase d-blockls-1 text-fade" href="#">{{ __('lang.AddCandidat') }}</a>
                 </div>
             </div>
             <div class="box">
                 <div class="box-body">
                     <div class="flexbox align-items-baseline mb-5">
                         <h6 class="text-uppercase ls-2 font-wieght-bold">{{ __('lang.Description') }}</h6>
                     </div>
